...
export default function TaxManagerAlerts() {
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      {/* Apple-style Modal for Alert Details */}
      <Modal 
        isOpen={isPanelOpen} 
            ...
            <>
              <ModalHeader className="flex flex-col gap-1">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-white text-xl font-semibold">Alert Details</h3>
                    <p className="text-gray-400 text-sm">Review and take action on this alert</p>
                  </div>
                </div>
              </ModalHeader>
                      ...
                      <CardBody className="p-6">
                        <div className="flex items-start justify-between mb-6">
                          <div className="flex items-center space-x-4">
                            <div className={`w-16 h-16 rounded-2xl flex items-center justify-center ${
                              selectedAlert.priority === 'high' ? 'bg-red-500/20' :
                              selectedAlert.priority === 'medium' ? 'bg-orange-500/20' :
                              'bg-green-500/20'
                            }`}>
                            ...
                            <div>
                              <h4 className="text-white text-2xl font-bold">{selectedAlert.client}</h4>
                              <p className="text-gray-400 text-sm">{selectedAlert.state} • {selectedAlert.issue}</p>
                            </div>
                          </div>
                          <div className={`px-4 py-2 rounded-xl text-sm font-semibold ${
                            selectedAlert.priority === 'high' ? 'bg-red-500/20 text-red-400' :
                            selectedAlert.priority === 'medium' ? 'bg-orange-500/20 text-orange-400' :
                            'bg-green-500/20 text-green-400'
                          }`}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div className="space-y-2">
                            ...
                            <p className="text-white text-lg font-semibold">{selectedAlert.currentAmount}</p>
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-white text-lg font-semibold">{selectedAlert.deadline}</p>
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-red-400 text-lg font-semibold">{selectedAlert.penaltyRisk}</p>
                    ...
                    <Card className="bg-white/5 backdrop-blur-xl border-white/10 rounded-2xl">
                      <CardBody className="p-6">
                        <div className="flex items-center space-x-3 mb-4">
                          ...
                          <h5 className="text-white text-lg font-semibold">Recommended Actions</h5>
                        </div>
                    ...
                    <Card className="bg-white/5 backdrop-blur-xl border-white/10 rounded-2xl">
                      <CardBody className="p-6">
                        <div className="flex items-center space-x-3 mb-6">
                          ...
                          <h5 className="text-white text-lg font-semibold">Make a Decision</h5>
                        </div>
                        
                        <div className="space-y-6">
                          <div>
                            <h6 className="text-white font-medium mb-3">My recommendation:</h6>
                          ...
                          <div>
                            <h6 className="text-white font-medium mb-3">Reasoning:</h6>
                            <Textarea
                              ...
                              classNames={{
                                input: "text-white",
                                inputWrapper: "bg-white/5 border-white/10 hover:border-white/20 focus-within:border-blue-500/50 rounded-xl"
                              }}
                            />
                          </div>
                        </div>
              ...
              <ModalFooter>
                <div className="flex items-center justify-between w-full">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <Button
                      className="bg-green-600 hover:bg-green-700 text-white rounded-xl shadow-lg shadow-green-600/25"
