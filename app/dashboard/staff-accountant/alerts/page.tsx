...
const staffAlerts: StaffAlert[] = [
  {
    id: "alert-001",
    title: "New Task Assignment: Q4 California Data Processing",
    message: "You have been assigned a new task to process Q4 2024 California sales data for TechCorp SaaS. This task requires data validation, state allocation, and threshold analysis. Quality expectations: 95% accuracy, complete documentation, supervisor review required.",
    ...
    learningContent: {
      title: "California Economic Nexus Processing",
      description: "Learn about California's specific requirements for economic nexus determination and data processing best practices.",
      resources: ["CA Nexus Guide", "Data Processing Checklist", "Quality Standards", "Supervisor Contact"]
    },
    qualityMetrics: {
      accuracy: 95,
      timeliness: 100,
  ...
  {
    id: "alert-002",
    title: "Client Communication Request: Missing Data",
    message: "RetailChain LLC has uploaded new sales data and is requesting validation confirmation. Please review the uploaded documents and respond with status update within 24 hours. Use approved communication template for professional response.",
    ...
    actions: [
      { id: "respond", label: "Send Response", type: "respond", primary: true },
      { id: "template", label: "Use Template", type: "respond" },
  ...
  {
    id: "alert-005",
    title: "System Update: New Data Validation Tools",
    message: "New automated validation tools have been deployed. These tools will help identify data inconsistencies and improve accuracy. Training session scheduled for tomorrow at 2 PM. Attendance required for all staff accountants.",
  ...
  {
    id: "alert-006",
    title: "Client Support: ManufacturingCo Data Upload",
    message: "ManufacturingCo is experiencing difficulties uploading their Q4 sales data. They've requested assistance with the upload process. Please contact them using the client support template and provide step-by-step guidance.",
    category: "client-communication",
    priority: "medium",
    status: "unread",
