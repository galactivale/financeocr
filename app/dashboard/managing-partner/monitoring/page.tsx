...
const ManagingPartnerMonitoring = () => {
  ...
  const clients: Client[] = useMemo(() => {
    ...
    if (isPersonalizedMode) {
      if (personalizedNexusAlertsLoading) {
        return [];
      }
    } else {
      if (alertsLoading) {
    ...
    const clientStatesToUse = isPersonalizedMode
      ? (personalizedClientStates && personalizedClientStates.length > 0 
          ? personalizedClientStates 
          : (clientStatesData?.clientStates && clientStatesData.clientStates.length > 0 
              ? clientStatesData.clientStates 
    ...
    // Debug logging
    console.log('🔍 Managing Partner Monitoring - Alert entries:', {
            ...
            <div className="flex space-x-3">
              <button 
                ...
                onClick={() => {
                  ...
                  router.push(`/dashboard/managing-partner/alerts/${selectedClient.alertId}`);
                }}
              >
                View Details
              </button>
